                ...
                <div class="row">
                    <div class="col-lg-2 col-6">
                        ...
                        <div class="small-box bg-light">
                            ...
                            <a href="{{ route('opforum.opencases') }}" class="small-box-footer">Info Lebih... <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                        <!-- ./col -->
                        <div class="col-lg-2 col-6">
                        ...
                        <div class="small-box bg-fuchsia">
                            ...
                            <a href="{{ route('opforum.onprogresscases') }}" class="small-box-footer">Info Lebih... <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-2 col-6">
                        ...
                        <div class="small-box bg-indigo">
                            ...
                            <a href="{{ route('opforum.onprogressnoguilt') }}" class="small-box-footer">Info Lebih... <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-2 col-6">
                        ...
                        <div class="small-box bg-orange">
                            ...
                            <a href="{{ route('opforum.onprogressguilt') }}" class="small-box-footer">Info Lebih... <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-6">
                        <!-- small box -->
                        <div class="small-box bg-gray">
                            ...
                            <a href="{{ route('opforum.pendingcases') }}" class="small-box-footer">Info Lebih... <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-2 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="{{ route('opforum.closedcasesnoguilt') }}" class="small-box-footer">Info Lebih... <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-2 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ route('opforum.closedcaseslowguilt') }}" class="small-box-footer">Info Lebih... <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-6">
                        <!-- small box -->
                        <div class="small-box bg-warning">
                            ...
                            <a href="{{ route('opforum.closedcasesmediumguilt') }}" class="small-box-footer">Info Lebih... <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-6">
                        <!-- small box -->
                        <div class="small-box bg-danger">
                            ...
                            <a href="{{ route('opforum.closedcaseshighguilt') }}" class="small-box-footer">Info Lebih... <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
