...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Forum - Closed Cases Kesalahan (Medium)</li>
    </ol>
@endsection
@section('content')
    <!-- Default box -->
    <div class="card table-responsive">
        <div class="card-header">
            <div class="float-right">
                <form id="searchForm" action="{{ route('olddata.olddatamediumguilt') }}" method="GET" class="form-inline">
            ...
            <h3 class="card-title">Data Closed Cases Kesalahan (Medium)</h3>
        </div>
        <div class="card-body">
            {!! $html->table() !!}
        </div>
