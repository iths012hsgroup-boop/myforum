...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Daftar Situs</li>
    </ol>
@endsection
@section('content')
    <!-- Default box -->
    <div class="card table-responsive">
        <div class="card-header">
            <h3 class="card-title">Data Situs</h3>
            <div class="float-right">
                <a href="{{ route('daftarsitus.new') }}" class="btn btn-primary">Tambahkan Situs Baru</a>
            </div>
        </div>
        <div class="card-body">
            {!! $html->table() !!}
