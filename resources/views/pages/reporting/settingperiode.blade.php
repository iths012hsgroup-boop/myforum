...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Setting Periode</li>
    </ol>
@endsection
@section('content')
    <!-- Default box -->
    <div class="card table-responsive">
        <div class="card-header">
            <h3 class="card-title">Setting Periode</h3>
            <div class="float-right">
                <a href="{{ route('periodessetting.new') }}" class="btn btn-primary">Tambahkan Periode Baru</a>
            </div>
        </div>
        <div class="card-body">
            {!! $html->table() !!}
                ...
                confirmButtonText: 'Ya, Hapus!'
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            url: "{{ route('periodessetting.destroy') }}",
                            dataType: 'JSON',
                            cache: false,
                            data: data,
