                    ...
                    $.ajax({
                        ...
                        success(res) {
                            if (res && res.success) {
                                ...
                                showPopup('error', (res && res.message) ||
                        ...
                        error(xhr) {
                            if (xhr.status === 422 && xhr.responseJSON && xhr.responseJSON.errors) {
                                ...
                                showPopup('error',
                                    'Terjadi kesalahan di server saat mengupdate absensi.');
                            }
                        }
                    });
                });
                ...
                $(document).on('click', '.delete-absensi-btn', function() {
                    ...
                    Swal.fire({
                        ...
                        $.ajax({
                            ...
                            error() {
                                showPopup('error',
                                    'Terjadi kesalahan saat menghapus data absensi di server.'
                                    );
                            },
                        });
                    });
