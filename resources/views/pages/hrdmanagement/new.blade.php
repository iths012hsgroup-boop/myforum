<div class="modal fade" id="newAbsensiModal" tabindex="-1" role="dialog" aria-labelledby="newAbsensiModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="newCheckTelat" name="kehadiran[]" value="TELAT">
                            <label class="form-check-label" for="newCheckTelat">TELAT</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="newCheckSakit" name="kehadiran[]" value="SAKIT">
                            <label class="form-check-label" for="newCheckSakit">SAKIT</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="newCheckIzin" name="kehadiran[]" value="IZIN">
                            <label class="form-check-label" for="newCheckIzin">IZIN</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="newCheckTanpaKabar" name="kehadiran[]" value="TANPA KABAR">
                            <label class="form-check-label" for="newCheckTanpaKabar">TANPA KABAR</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="newCheckCuti" name="kehadiran[]" value="CUTI">
